...
export default function MsgRefer({ message }) {
  const { displayRefer, setDisplayRefer } = useTask();
  ...
  return (
    <div className={displayRefer ? `fixed z-10 inset-0 flex items-center justify-center bg-black bg-opacity-50` : `hidden`}>
